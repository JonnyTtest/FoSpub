...
sum(Win) ## overall
avg <- sum(Win)/nloop ## on average per game
cat("For 10000 rounds we get an average profit of", avg, "compared to the theoretical value of", -17/216)
...
sum(Win) ## overall
avg <- sum(Win)/nloop ## on average per game
cat("For 100000 rounds we get an average profit of", avg, "compared to the theoretical value of", -17/216)
```
...
From the plot, it is evident that the average profit converges to the theoretical expected value (keyword: law of large numbers).
