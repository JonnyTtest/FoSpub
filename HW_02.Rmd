...
$$\bigcup_{n=1}^\infty A_n = \{X \leq n \text{ for at least one } n\} = \Omega$$
...
**Given:** $F$ is left-limited, meaning the left limit $F(x^-) = lim_{z\nearrow x}$ $F(z)$ exists at every point $x \in\mathbb{R}$.

**To show:** $F$ can satisfy $F(x) \neq F(x^-)$, i.e., $F$ is not necessarily left-continuous.
...
![](images/sheet_02_ex_03.png)

### Exercise 4

![](images/sheet_02_ex_04.png)
...
...
Trivially true: $p_1 = p_1$, $2q_1 = 2q_1$, $r_1 = r_1 \checkmark$ 
