...
par(mfrow=c(1,2)) 
hist(y_max, freq=FALSE, main="Dichte von Max(U,V)", xlab="y", col="lightblue")
curve(2*x, add=TRUE, col="red", lwd=2) 

hist(z_min, freq=FALSE, main="Dichte von Min(U,V)", xlab="z", col="lightgreen")
curve(2-2*x, add=TRUE, col="red", lwd=2)
```

#### b


![](images/Zettel6Nr2_b.jpeg)


#### c


![](images/Zettel6Nr2_c.jpeg)
